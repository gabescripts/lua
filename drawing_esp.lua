...
function CreateDraw.new(Settings, Services)
  ...
  LPH_NO_VIRTUALIZE(function()
      ...
      while not self.Destroyed do task.wait(Settings.Options.Tick or 0.025)
          if Settings.Type == "Player" then
          if not self.Object.Character then continue end;
          if self.Destroyed then break end;
      
          local canShow = false
          local Character = (Settings.Type == "Player" and self.Object.Character) or (Settings.Type ~= "Player" and self.Object)
          ...
          if Character and Character.Parent then
              ...
              -- Check if essential parts exist (StreamingEnabled might have removed them)
              if RootPart and (Settings.Type == "Object" or Humanoid) then
                  canShow = true
              end
          end

          -- If we can't show the ESP (Streamed out or dead), hide everything and skip logic
          if not canShow then
              for _, drawing in next, self.Creations do
                  drawing.Visible = false
              end
              continue
          end

          local Character = self.Object.Character
          local RootPart = FindFirstChild(Character, "HumanoidRootPart")
          local Humanoid = FindFirstChild(Character, "Humanoid")
          ...
          if RootPart then
              ...
              if RootPartVis then
                  ...
                  --// Sets Tracer Color Visibility Line Color
          ...
          --// Skeleton Update, Separated Into Conditions So Other Lines Still Show If Some Limbs Are Missing
          if RootPart then
              ...
              --// Right Hand Line Position Update
              ...
              --// Left Hand Line Position Update
              ...
              --// Left Foot Line Position Update
              ...
              --// Right Foot Line Position Update
          ...
          if RightHand and LeftHand and Head and RightFoot and LeftFoot and RootPart then
              ...
              local RightHandPos, RightHandVis = WorldToViewportPoint(Camera, RightHand.Position - AddOffset)
              local LeftHandPos, LeftHandVis = WorldToViewportPoint(Camera, LeftHand.Position - AddOffset)
              local RightFootPos, RightFootVis = WorldToViewportPoint(Camera, RightFoot.Position - AddOffset)
              ...
              if HandsVisible and FeetVisible and HeadVis then
                  ...
                  --// Distance Text And Position Update
                  ...
                  --// Health Bar Color And Size Update
                  if Humanoid then
                  ...
                  --// Health Bar Size And Position Update
              ...
              --// Distance Visibility Update
              self.Creations.Distance.Visible = (RootPartVis and Settings.Options.Enabled and Settings.Options.Distance) or false
              end
          end
          elseif Settings.Type == "Custom" then
          --// For Any Custom Characters
          elseif Settings.Type == "Humanoid" then
          --// For Any Humanoid Object 
          elseif Settings.Type == "Object" then
          --// For Any Object
          end
      end
      end)()
  ...
  if Settings.Type == "Player" then
      ...
      if self.Object ~= Player then return end;
      self:Destroy()
      end)
  end
  ...
  --// Tracer Method Functions
  self.Methods.Tracer = {}
  function self.Methods.Tracer:SetColor(self, Color)
      self.Creations.LineTracer.Color = Color
  end
  function self.Methods.Tracer:SetSize(self, Value)
      self.Creations.LineTracer.Thickness = 1 + Value
  end
  ...
  --// Boxes Method Functions
  self.Methods.Boxes = {}
  function self.Methods.Boxes:SetColor(self, Color)
      self.Creations.BoxMain.Color = Color
  end
  function self.Methods.Boxes:SetSize(self, Size)
      self.Creations.BoxMain.Thickness = 2 + Size
      self.Creations.BoxMain.Thickness = 1 + Size
  end
  function self.Methods.Boxes:Toggle(State) Settings.Options.Boxes = State end

  --// Skeleton Method Functions
  ...
  function self.Methods.Skeleton:HideArms(State)
      Settings.Options.HideArms = State
  end
  function self.Methods.Skeleton:Toggle(State) Settings.Options.Skeleton = State end

  --// Health Method Functions
  self.Methods.Health = {}
  ...
  function self:Destroy()
      ...
      table.remove(TotalDraw, table.find(TotalDraw, self))
  end
  function self:IsObstructed(Position, Ignore)
      return #GetPartsObscuringTarget(Camera, {Position}, Ignore or {}) > 0
  end
