...
Section1:Slider("Slider", 0, 25, 5, 0.5, "Slider", function(t) print(t) end)
...
Section3:Bind("Normal Bind", Enum.KeyCode.F, false, "BindNormal", function() print("Bind pressed") end)
